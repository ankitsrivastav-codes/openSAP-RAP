...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zas_s_rap_travel( <entity> MAPPING FROM ENTITY ).
...
CLASS lhc_Booking IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx      = CORRESPONDING zas_s_rap_booking( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZI_AS_TRAVEL_U_OS DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_AS_TRAVEL_U_OS IMPLEMENTATION.
